...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-3-1.png)<!-- -->
...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-8-1.png)<!-- --> To
construct the excellent dataset, I filtered brfss to only include values
of “Excellent” for the response variable. I grouped the data by both
year and state which allowed me to use the mutate function to create a
new variable “mean_datavalue” which was the average of the data_value
for each state separated by year. Afterwards, I used the `select()`
function to select only the variables year, state, and mean_datavalue.
Last, I used the `distinct()` function to only keep unique rows.
...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-9-1.png)<!-- --> To
create a two-panel plot, I first loaded the patchwork library using
...
``` r
demo_df=
  readxl::read_excel("Data/nhanes_covar.xlsx", range="A5:E255") |> 
  janitor::clean_names() |> 
...
accel_df=
  readxl::read_excel("Data/nhanes_accel.xlsx", range="A1:BCK251") |> 
  janitor::clean_names() |> 
  pivot_longer(
    min1:min1440,
    names_to = "minutes",
...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-11-1.png)<!-- -->
...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
...
![](p8105_hw3_ajt2206_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->
